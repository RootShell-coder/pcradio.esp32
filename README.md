...
![PCRadio 2.0](docs/WebUi/PCRadio-v2.0.0.png)
...
- Полная свобода: можно копировать, менять, продавать и распространять работу.
- Без гарантий: автор не дает никаких обещаний, не отвечает за ошибки.
- Без ограничений: правила сводятся к одной фразе - делай что хочешь.
