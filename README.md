...
Исправлена ошибка восстановления радиопотока после кратковременной потери
доступа в интернет при сохранённом подключении к Wi-Fi. Ошибка проявлялась,
если во время воспроизведения временно отключить интернет, не разрывая
соединение устройства с точкой доступа: остаток аудиобуфера воспроизводился
прерывисто, а после возвращения сети устройство не всегда могло корректно
переподключиться к станции и возобновить звук.

В версии 2.0.1 исправлены обработка опустошения буфера, интервалы повторных
подключений, защита восстановленного соединения от ложного разрыва и управление
мощностью Wi-Fi во время сетевого сбоя. Воспроизведение теперь возобновляется
автоматически после восстановления доступа в интернет.
